...
public class SimpleExample {
  ...
  public void test() {
	  ...
	  acc.setEmailAddress("111@anshen.com");
	  acc.setFirstName("anshen");
	  acc.setId(1);
	  acc.setLastName("loton");
	  try {
		SimpleExample.insertAccount(acc);
	} catch (SQLException e) {
		e.printStackTrace();
		System.err.println("Something wrong with you!");
	}
  }
